...
namespace CascStuff
{
    class Wdt
    {
        ...
        string path = "";
        public float max_height = -9999;
        public float min_height = 9999;
        ...
        public Wdt(int wdt_name, string p, Dictionary<uint, string> lf, Dictionary<string, uint> fl, Dictionary<uint, List<Toolbox.IngameObject>> IG_Obj)
        {
            wdt_id = wdt_name;
            path = p;
            listfile = lf;
            filelist = fl;
           //ParseWdtPath(path, IG_Obj);
        }
