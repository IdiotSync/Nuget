...
namespace CascStuff
{
    class Toolbox
    {
        ...
        public class CsvMap
        {
            ...
            public string PvpShortDescription_lang { get; set; }
            public string PvpLongDescription_lang { get; set; }
            //public float Corpse0 { get; set; }
            //public float Corpse1 { get; set; }
        ...
        public class CsvArea
        {
            ...
            public int Flags_0 { get; set; }
            public int Flags_1 { get; set; }
            public int LiquidTypeID_0 { get; set; }
        ...
        public static List<CsvArea> Listareas()
        {
            ...
            {
                csv.Configuration.PrepareHeaderForMatch = (string header, int index) => header.Replace("[","").Replace("]","").ToLower();
